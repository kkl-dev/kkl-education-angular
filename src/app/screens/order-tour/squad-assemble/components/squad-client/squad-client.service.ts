        ...
        questions: [
          ...
          new QuestionAutocomplete({
            ...
            inputProps: {
              options: [
                {
                  value: '521829121 - בית ספר תמיר',
                  label: '521829121 בית ספר תמיר',
                },
                {
                  value: '320382983 - מתנס אבן יהודה',
                  label: '320382983 מתנס אבן יהודה',
                },
                {
                  value: '428948934 - הגימנסיה הריאלית',
                  label: '428948934 הגימנסיה הריאלית',
                },
              ],
            },
          }),
