...
export class OrderService {
    ...
    /**
     * need to check two conditions on the server aboute activities before adding orders
     * @param tripId 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public addGudianceOrdersByGudiesNum(tripId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<OrderEvent>>;
    public addGudianceOrdersByGudiesNum(tripId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<OrderEvent>>>;
    public addGudianceOrdersByGudiesNum(tripId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<OrderEvent>>>;
    public addGudianceOrdersByGudiesNum(tripId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (tripId === null || tripId === undefined) {
            throw new Error('Required parameter tripId was null or undefined when calling addGudianceOrdersByGudiesNum.');
        }
        ...
        return this.httpClient.get<Array<OrderEvent>>(`${this.configuration.basePath}/order/gudianceOrder/${encodeURIComponent(String(tripId))}`,
            {
