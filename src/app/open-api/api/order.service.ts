...
export class OrderService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public editOrder(userName: string, permId: number, descOccupancyProbFromSp: string, isRemoveOccProb: number, requestBody?: Array<OrderEvent>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<TripModel>;
    public editOrder(userName: string, permId: number, descOccupancyProbFromSp: string, isRemoveOccProb: number, requestBody?: Array<OrderEvent>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<TripModel>>;
    public editOrder(userName: string, permId: number, descOccupancyProbFromSp: string, isRemoveOccProb: number, requestBody?: Array<OrderEvent>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<TripModel>>;
    public editOrder(userName: string, permId: number, descOccupancyProbFromSp: string, isRemoveOccProb: number, requestBody?: Array<OrderEvent>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (userName === null || userName === undefined) {
