...
export class UserService {
    ...
    public getAvailableAccomodationDates(fieldForestCenterId: number, fromDate: string, tillDate: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<AvailableAccomodationDate>>(`${this.configuration.basePath}/getAvailableDates/${encodeURIComponent(String(fieldForestCenterId))}/${encodeURIComponent(String(fromDate))}/${encodeURIComponent(String(tillDate))}`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getAvailableFacilities(fieldForestCenterId: number, fromDate: string, tillDate: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<FacilityDate>>(`${this.configuration.basePath}/getAvailableFacilities/${encodeURIComponent(String(fieldForestCenterId))}/${encodeURIComponent(String(fromDate))}/${encodeURIComponent(String(tillDate))}`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCustomersByParams(pageIndex?: number, pageSize?: number, sort?: string, search?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<CustomerPagination>;
    public getCustomersByParams(pageIndex?: number, pageSize?: number, sort?: string, search?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<CustomerPagination>>;
    public getCustomersByParams(pageIndex?: number, pageSize?: number, sort?: string, search?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<CustomerPagination>>;
    public getCustomersByParams(pageIndex?: number, pageSize?: number, sort?: string, search?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<CustomerPagination>(`${this.configuration.basePath}/customers`,
            {
